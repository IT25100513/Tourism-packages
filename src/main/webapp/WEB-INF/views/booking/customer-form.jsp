...
<head>
    <jsp:include page="/WEB-INF/views/fragments/head.jsp">
        <jsp:param name="pageTitle" value="New booking"/>
    </jsp:include>
</head>
...
<div class="container pb-5" style="max-width:560px;">
    <h1 class="h3 fw-bold text-page-title mb-2">Reserve a getaway</h1>
    <p class="text-page-sub mb-4">Choose your package and when you’d like travel to begin—planners confirm availability next.</p>
    ...
    <div class="tp-content-card tp-glass-rise tp-animate-fade-up">
        <div class="card-body p-4 p-lg-5">
            ...
            <form class="needs-validation" method="post" action="${pageContext.request.contextPath}/bookings/create" novalidate>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text mb-1">Dates use your browser’s calendar · must be today or later (within two years).</div>
                ...
                <button class="btn btn-primary btn-lg w-100 rounded-3 fw-bold" type="submit"><i class="bi bi-send me-2"></i>Submit request</button>
